...
class ams_odbc_db_dev
{
  ...
  /**
  * Returns one-column query data in the form of a collapsed, one-dimensional array
  */
  ...
  * @param 	$params	array	array of arrays with format (placeholder, value, datatype) for each variable in SQL
  */
  ...
  public function querySafe( $sql, $params, $fetch_style = OCI_ASSOC )
  {
    ...
    if ($this->conn !== FALSE)
    {
      ...
      {
        list($placeholder, $var) = $param_group;
        oci_bind_by_name( $stmt, $placeholder, $var );
      }
      oci_execute( $stmt );
